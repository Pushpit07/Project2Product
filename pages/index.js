...
const Home = () => {
  ...
  const validateInput = () => {
    return (productName.length && productDescription.length && email.length && (email.split("").filter(x => x === "@").length == 1) && (email.indexOf(".") !== -1));
  };

  function runDemo(apiOutput) {
    // Initialization 
    ...
    slide1.addText(
      [
        { text: apiOutput[1], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide2.addText(
      [
        { text: apiOutput[3], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide3.addText(
      [
        { text: apiOutput[5], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide4.addText(
      [
        { text: apiOutput[7], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide5.addText(
      [
        { text: apiOutput[9], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide6.addText(
      [
        { text: apiOutput[11], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide7.addText(
      [
        { text: apiOutput[13], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide8.addText(
      [
        { text: apiOutput[15], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide9.addText(
      [
        { text: apiOutput[17], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide10.addText(
      [
        { text: apiOutput[19], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide11.addText(
      [
        { text: apiOutput[21], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
    ...
    slide12.addText(
      [
        { text: apiOutput[23], options: { fontSize: 16, breakLine: true } },
      ],
      { x: 0.7, y: 2.2, w: 8.5, h: 2.5, color: "FFFFFF", valign: "middle", align: "center", isTextBox: true }
    );
      ...
      <div className="container">
        <div className="header">
          ...
          <div className="header-subtitle">
            <h2>Transforming your side-projects and hackathon-projects into profitable products. <br />Just enter your project name and project description, Project2Product will help you turn it into a successful venture.</h2>
          </div>
        </div>
